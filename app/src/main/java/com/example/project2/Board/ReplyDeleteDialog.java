...
import com.example.project2.VolleyRequest.ReplyDeleteRequest;
...
public class ReplyDeleteDialog extends Activity {
    private static String URL_LOADING = "http://43.201.55.113/LoadReplyCount.php";

    Button noBtn, yesBtn;
    String getIdx, getParent, reply_count;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getParent = intent.getStringExtra("parent");
                        ...
                        try {
                            ...
                            if(success.equals("1")){
                                for(int i = 0; i < jsonArray.length(); i++){
                                    ...
                                    String is_deleted = object.getString("is_deleted".trim());
                                    ...
                                    yesBtn.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            if(reply_count.equals("1") && is_deleted.equals("1")){
                                                    ...
                                                    public void onResponse(String response) {
                                                        try {
                                                            ...
                                                            if (success) {//정보수정에 성공한 경우
                                                                Toast.makeText(ReplyDeleteDialog.this, "답글이 삭제되었습니다.", Toast.LENGTH_SHORT).show();
                                                                new Thread(new Runnable() {
                                                                    public void run() {
                                                                        ReplyDeleteDialog.this.runOnUiThread(new Runnable() {
                                                                            public void run() {
                                                                            }
                                                                        });
                                                                    }
                                                                ...
                                                                Toast.makeText(ReplyDeleteDialog.this,"삭제에 실패하였습니다.",Toast.LENGTH_SHORT).show();
                                                                return;
                                                            }
                                                ...
                                                ReplyDeleteRequest replyDeleteRequest = new ReplyDeleteRequest(getIdx, getParent, responseListener);
                                                RequestQueue queue = Volley.newRequestQueue(ReplyDeleteDialog.this);
