...
import com.example.project2.Adapter.ReplyAdapter;
import com.example.project2.OnListItemSelectedInterface;
import com.example.project2.R;
import com.example.project2.VolleyRequest.ReplyRequest;
...
public class ReplyList extends AppCompatActivity implements OnListItemSelectedInterface {
    ...
    private static final String PRODUCT_URL = "http://43.201.55.113/ReplyList.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(comment_profileImg.equals("basic_image")){
            ...
            Glide.with(this).load("http://43.201.55.113" + comment_profileImg).override(50, 50).into(profileImg);
        }
