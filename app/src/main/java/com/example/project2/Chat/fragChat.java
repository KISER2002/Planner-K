...
import com.example.project2.Adapter.ChatRoomAdapter;
...
public class fragChat extends Fragment implements OnListItemSelectedInterface {
    ...
    private static String URL_LOADING = "http://43.201.55.113/LoadChatList.php";
    private static final String PRODUCT_URL = "http://43.201.55.113/ChatList.php";
