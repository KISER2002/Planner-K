...
import com.example.project2.VolleyRequest.EditLabelRequest;
...
public class EditLabelActivity extends AppCompatActivity {
    ...
    private String selectedColorStr_kor;
    private int selectedColorInt;
    private int colorIdx;
    String pk, bno, colorStrKor, colorStr;
    int idx, colorInt;
    String title = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        idx = intent.getIntExtra("idx", 31);
        title = intent.getStringExtra("title");
        colorStrKor = intent.getStringExtra("colorStrKor");
        colorStr = intent.getStringExtra("colorStr");
        colorInt = intent.getIntExtra("colorInt", -9342607);

        binding.pageTitle.setText("라벨 수정");
        selectedColorStr = colorStr;
        selectedColorStr_kor = colorStrKor;
        selectedColorInt = colorInt;
        colorIdx = idx;

        binding.titleEt.setText(title);
        binding.colorText.setText(colorStrKor);
        binding.colorText.setTextColor(colorInt);
        ...
        binding.addBackBtn.setText("삭제");
        binding.addBackBtn.setTextColor(Color.RED);
        binding.addBackBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                android.app.AlertDialog.Builder builder = new AlertDialog.Builder(EditLabelActivity.this);
                builder.setTitle("삭제").setMessage("해당 라벨을 삭제하시겠습니까?")
                        .setPositiveButton("삭제", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    public void onResponse(String response) {
                                        try {
                                            ...
                                            if (success) {//정보수정에 성공한 경우
                                                Toast.makeText(getApplicationContext(), "라벨이 삭제되었습니다.", Toast.LENGTH_SHORT).show();
                                ...
                                LabelDeleteRequest labelDeleteRequest = new LabelDeleteRequest(pk, responseListener);
                                RequestQueue queue = Volley.newRequestQueue(EditLabelActivity.this);
                                queue.add(labelDeleteRequest);
                            }
                        })
        ...
        binding.addLabelBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(title.equals("") && selectedColorStr.equals("no_color")){
                    ...
                    //서버로 volley 를 이용해서 요청을 함
                    EditLabelRequest editLabelRequest = new EditLabelRequest(pk, String.valueOf(colorIdx), title, selectedColorStr_kor, selectedColorStr, String.valueOf(selectedColorInt), responseListener);
                    RequestQueue queue = Volley.newRequestQueue(EditLabelActivity.this);
                    queue.add(editLabelRequest);
                }
            }
        });
    }
