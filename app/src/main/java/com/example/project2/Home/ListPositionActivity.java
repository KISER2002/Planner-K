...
public class ListPositionActivity extends AppCompatActivity {
    private static final String PRODUCT_URL = "http://43.201.55.113/ListCountList.php";
    private EditPositionAdapter editListAdapter;
    private RecyclerView recyclerView;
    private String getIdx, getListIdx, getOldBoardIdx;
    private int tempIdx;
    ...
    public void onResume() {
        ...
        getOldBoardIdx = intent.getStringExtra("old_board_idx");
    ...
    private void loadProducts(String bno) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, PRODUCT_URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            LinearLayoutManager layoutManager = new LinearLayoutManager(ListPositionActivity.this, LinearLayoutManager.VERTICAL, false);
                            editListAdapter = new EditPositionAdapter(cardCount, ListPositionActivity.this);
                            ...
                            e.printStackTrace();
                            Toast.makeText(ListPositionActivity.this,"실패",Toast.LENGTH_SHORT).show();
                        }
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(ListPositionActivity.this,"Volley 통신 에러.",Toast.LENGTH_SHORT).show();
                    }
                })
        {
            @Nullable
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(ListPositionActivity.this);
