...
public class ListFragment extends Fragment {
    ...
    private com.example.project2.A.MySwipeRefreshLayout mRefreshLayout;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.a_list_layout, container, false);
        mRefreshLayout = (com.example.project2.A.MySwipeRefreshLayout) view.findViewById(R.id.swipe_refresh_layout);
    ...
    private void setupListRecyclerView() {
        ...
        ItemAdapter listAdapter = new ItemAdapter(getActivity(), mItemArray, R.layout.list_item, R.id.image, false);
    ...
    private void setupGridVerticalRecyclerView() {
        ...
        ItemAdapter listAdapter = new ItemAdapter(getActivity(), mItemArray, R.layout.a_grid_item, R.id.item_layout, true);
        mDragListView.setAdapter(listAdapter, true);
