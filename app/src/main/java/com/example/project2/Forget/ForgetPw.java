...
public class ForgetPw extends AppCompatActivity {
    public static Activity forgetPw;

    private Button findBtn;
    private EditText idEt, emailEt, emailConfirmEt;
    private Button emailSendBtn, emailCheckBtn;
    private String id, name;
    private static String URL_ID_FIND = "http://43.201.55.113/PwFind.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        forgetPw = ForgetPw.this;

        findBtn = findViewById(R.id.find_btn);
        idEt = findViewById(R.id.forget_id_et);
        ...
        findBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String name = idEt.getText().toString().trim();
    ...
    private void Find(String userID, String userEmail){
                        ...
                        try {
                            ...
                            if(success.equals("1")){ // 로그인 성공
                                for(int i = 0; i < jsonArray.length(); i++){
                                    ...
                                    Intent intent = new Intent(ForgetPw.this, FindPw.class);
