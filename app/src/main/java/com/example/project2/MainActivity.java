...
import com.example.project2.Forget.ForgetActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static String URL_LOGIN = "http://43.201.55.113/Login.php";
                        ...
                        try {
                            ...
                            if(success.equals("1")){ // 로그인 성공
                                for(int i = 0; i < jsonArray.length(); i++){
                                    ...
                                    sessionManager.createSession(profile, name, id);
