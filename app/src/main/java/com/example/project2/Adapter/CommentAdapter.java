...
import com.example.project2.Board.Comment;
...
import com.example.project2.Board.CommentEdit;
import com.example.project2.Board.ReplyDeleteDialog;
import com.example.project2.Board.ReplyList;
import com.example.project2.R;
import com.example.project2.ViewType.CommentViewType;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        if(holder instanceof CommentViewHolder){
            ...
            if(profile.equals("basic_image")){
                ...
                Glide.with(context).load("http://43.201.55.113" + profile).override(50, 50).into(((CommentViewHolder) holder).writer_profile_image);
            }
            ...
            if(profile.equals("basic_image")){
                ...
                Glide.with(context).load("http://43.201.55.113" + profile).override(50, 50).into(((ReplyViewHolder) holder).writer_profile_image);
            }
            if(!writerId.equals(mId)){
